...
_GALLERY_GROUPS: tuple[GalleryGroup, ...] = (
    ...
    GalleryGroup(
        ...
        (
            ...
            GalleryItem("Graph", route="/charts/graph/"),
...
""",
    "Graph": """
<path d="M110 96L160 116M160 116L210 96M160 116L130 155M160 116L190 155M110 96L210 96M130 155L190 155" class="preview-line preview-line-soft"/><circle cx="110" cy="96" r="6" class="preview-dot"/><circle cx="210" cy="96" r="6" class="preview-dot"/><circle cx="160" cy="116" r="7" class="preview-dot"/><circle cx="130" cy="155" r="5" class="preview-dot-soft"/><circle cx="190" cy="155" r="5" class="preview-dot-soft"/>
""",
    "Triangle Mesh": """
