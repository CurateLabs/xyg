---
title: Integrations
description: Use XYG in Reflex applications, notebooks, and Matplotlib-shaped workflows.
---

# Integrations

XYG's core composition API is framework-neutral. Integrations decide how a
...
- [Reflex](/docs/xy/integrations/reflex/) covers static and state-backed charts,
  semantic events, and streaming through the bundled `xyg[reflex]` integration.
...
- [Matplotlib (`xyg.pyplot`)](/docs/xy/integrations/matplotlib/) covers the
  compatibility boundary and a gradual migration to XYG's declarative API.
