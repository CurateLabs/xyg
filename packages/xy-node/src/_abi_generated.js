...
export const ABI_VERSION = 312;
export const SIGNATURE_SHA256 = "43f64eb83dcec91f98bffa12ee76aacd4b6e59564be4616fdab8646cde547a11";
...
export function bindGeneratedAbi(lib) {
  ...
  xyPayloadColumnShipPlan = lib.func("int32_t xyg_payload_column_ship_plan(const uint8_t * kind, size_t kind_len, int32_t x_axis_type, int32_t y_axis_type, int32_t * out_gather_policy, int32_t * out_gather_include_color, size_t * out_n_columns, int32_t * out_x_ship_scale, int32_t * out_y_ship_scale, void * out_columns, size_t capacity)");
