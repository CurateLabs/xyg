...
export const ABI_VERSION = 365;
export const SIGNATURE_SHA256 = "3a78c0691d0ec79209d08b6c6aa2cddea008739a9c394ed5062ff1e87c677118";
...
export let xyScenePackNamedColorbar;
...
export let xyStaticAnnotationStyle;
export let xyStaticDocumentExport;
export let xyStaticDocumentLabels;
export let xyStaticDocumentLayout;
export let xyStaticDocumentLegend;
export let xyStaticLegendFit;
export let xyStaticPanelChrome;
...
function _setGeneratedAbiBinding(name, value) {
  switch (name) {
    ...
    case "xyScenePackNamedColorbar": xyScenePackNamedColorbar = value; return;
    ...
    case "xyScenePlotRect": xyScenePlotRect = value; return;
    ...
    case "xyStaticAnnotationStyle": xyStaticAnnotationStyle = value; return;
    case "xyStaticDocumentExport": xyStaticDocumentExport = value; return;
    case "xyStaticDocumentLabels": xyStaticDocumentLabels = value; return;
    case "xyStaticDocumentLayout": xyStaticDocumentLayout = value; return;
    case "xyStaticDocumentLegend": xyStaticDocumentLegend = value; return;
    case "xyStaticLegendFit": xyStaticLegendFit = value; return;
    case "xyStaticPanelChrome": xyStaticPanelChrome = value; return;
...
export function bindGeneratedAbi(lib) {
  ...
  xyScenePackNamedColorbar = lib.func("int32_t xyg_scene_pack_named_colorbar(uint8_t flags, double lo, double hi, const uint8_t * text_rgba, const uint8_t * title, size_t title_len, const uint8_t * name, size_t name_len, uint32_t n_ticks, const double * ticks, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyScenePackNamedColorbar", xyScenePackNamedColorbar);
  ...
  xyStaticAnnotationStyle = lib.func("size_t xyg_static_annotation_style(const uint8_t * encoded, size_t encoded_len, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyStaticAnnotationStyle", xyStaticAnnotationStyle);
  xyStaticDocumentExport = lib.func("size_t xyg_static_document_export(const uint8_t * encoded, size_t encoded_len, uint32_t format, double scale, int32_t quality, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyStaticDocumentExport", xyStaticDocumentExport);
  xyStaticDocumentLabels = lib.func("size_t xyg_static_document_labels(const uint8_t * encoded, size_t encoded_len, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyStaticDocumentLabels", xyStaticDocumentLabels);
  xyStaticDocumentLayout = lib.func("size_t xyg_static_document_layout(const uint8_t * encoded, size_t encoded_len, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyStaticDocumentLayout", xyStaticDocumentLayout);
  xyStaticDocumentLegend = lib.func("size_t xyg_static_document_legend(const uint8_t * encoded, size_t encoded_len, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyStaticDocumentLegend", xyStaticDocumentLegend);
  xyStaticLegendFit = lib.func("size_t xyg_static_legend_fit(const uint8_t * encoded, size_t encoded_len, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyStaticLegendFit", xyStaticLegendFit);
  xyStaticPanelChrome = lib.func("size_t xyg_static_panel_chrome(const uint8_t * encoded, size_t encoded_len, uint8_t * out, size_t out_cap)");
  _rawGeneratedAbi.set("xyStaticPanelChrome", xyStaticPanelChrome);
