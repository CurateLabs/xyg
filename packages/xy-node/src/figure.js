...
export class Figure {
  ...
  */
  ...
  _emitLine(t, pw, xr, pxWidth) {
    ...
    // Node payload line omits animation. Python `_base_entry` ships
    // t.animation. Matching Python would add entry.animation. Recorded
  ...
  _polarAxisSpecs(xr, yr) {
    ...
    return {
      x: {
        ...
        // Node polar payload axes omit side. Python `_axis_spec` ships
        ...
        // Node polar payload axes omit tick_labels. Python `_axis_spec` ships
        // `tick_labels`. Matching Python would add x_axis.tick_labels. Recorded
        // emit-polar-payload-axis-tick-labels stay-host.
        ...
        // Node polar payload axes omit tick_label_sides. Python `_axis_spec` ships
        // `tick_label_sides`. Matching Python would add x_axis.tick_label_sides. Recorded
        // emit-polar-payload-axis-tick-label-sides stay-host.
        ...
        // Node polar payload axes omit label_offset. Python `_axis_spec` ships
        // `label_offset`. Matching Python would add x_axis.label_offset. Recorded
        // emit-polar-payload-axis-label-offset stay-host.
        // Node polar payload axes omit label_angle. Python `_axis_spec` ships
        // `label_angle`. Matching Python would add x_axis.label_angle. Recorded
        // emit-polar-payload-axis-label-angle stay-host.
        // Node polar payload axes omit tick_label_angle. Python `_axis_spec` ships
        // `tick_label_angle`. Matching Python would add x_axis.tick_label_angle. Recorded
        // emit-polar-payload-axis-tick-label-angle stay-host.
        // Node polar payload axes omit tick_label_strategy. Python `_axis_spec` ships
        // `tick_label_strategy`. Matching Python would add x_axis.tick_label_strategy. Recorded
        // emit-polar-payload-axis-tick-label-strategy stay-host.
        // Node polar payload axes omit tick_label_anchor. Python `_axis_spec` ships
        // `tick_label_anchor`. Matching Python would add x_axis.tick_label_anchor. Recorded
        // emit-polar-payload-axis-tick-label-anchor stay-host.
        // Node polar payload axes omit tick_label_min_gap. Python `_axis_spec` ships
        // `tick_label_min_gap`. Matching Python would add x_axis.tick_label_min_gap. Recorded
        // emit-polar-payload-axis-tick-label-min-gap stay-host.
        ...
        scale: "linear",
        theta_unit: unit,
        theta_zero: (this.axis_options?.x ?? {}).theta_zero ?? "E",        // Node polar payload axes omit categories. Python `_axis_spec` ships
        // `_axis_categories` for category axes. Matching Python would add
        // x_axis.categories. Recorded emit-polar-payload-axis-categories stay-host.
        // Node polar payload axes omit nonpositive. Python `_axis_spec` ships
        // `nonpositive` on log axes. Matching Python would add y_axis.nonpositive.
        // Recorded emit-polar-payload-axis-nonpositive stay-host.
        // Node polar payload axes omit style. Python `_axis_spec` ships
  ...
  buildPayload({ split = false, pxWidth = null } = {}) {
    ...
    const axisSpecs =
      this.coords === "polar" ? this._polarAxisSpecs(xr, yr) : {
        ...
        // ships `tick_values`. Matching Python would add x_axis.tick_values.
        // Recorded emit-payload-axis-tick-values stay-host.
        // Node cartesian payload axes omit minor_tick_values. Python
