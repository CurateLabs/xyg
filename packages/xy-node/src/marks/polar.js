 ...
 *
 * Polar geometry and wind-rose binning live in Rust (`xyg_wind_rose_bins`,
 * `xyg_bar_stack`, `xyg_sector_triangles`). These helpers assemble marks the same
...
/**
 * Wind rose: `xyg_wind_rose_bins` + stacked polar bars.
 *
