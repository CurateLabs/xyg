...
export { ABI_VERSION, nativeLibraryFileName, NATIVE_LIBRARY_NAMES } from "./native-path.js";
...
const xygAbiVersion = lib.func("uint32_t xyg_abi_version()");
assertAbiVersion(xygAbiVersion());
export const xyAbiVersion = xygAbiVersion;

// C ABI signatures from crates/xyg-core/src/lib.rs / python/xy/_native.py.
...
export const xyIsSorted = lib.func("int32_t xyg_is_sorted(const double *data, size_t len)");
...
export const xyBin2dF32 = lib.func(
  "int32_t xyg_bin_2d_f32(const float *x, const float *y, size_t len, float x0, float x1, float y0, float y1, size_t w, size_t h, float *out)",
);
...
export const xyStackedBounds = lib.func(
  "int32_t xyg_stacked_bounds(const double *values, size_t n_series, size_t n_points, uint32_t mode, double *lower, double *upper)",
);
