...
def _load() -> ctypes.CDLL:
    ...
    lib.xyg_graph_projection_create.restype = ctypes.c_int32
    lib.xyg_graph_projection_create.argtypes = [
        ctypes.POINTER(_GraphProjectionDescriptor),
        ctypes.POINTER(ctypes.c_uint64),
    ]
    lib.xyg_graph_projection_counts.restype = ctypes.c_int32
    lib.xyg_graph_projection_counts.argtypes = [
        ctypes.c_uint64,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.POINTER(ctypes.c_uint32),
    ]
    lib.xyg_graph_projection_copy_node_ids.restype = ctypes.c_int32
    lib.xyg_graph_projection_copy_node_ids.argtypes = [
        ctypes.c_uint64,
        ctypes.c_void_p,
        ctypes.c_uint64,
    ]
    lib.xyg_graph_projection_copy_edge_ids.restype = ctypes.c_int32
    lib.xyg_graph_projection_copy_edge_ids.argtypes = [
        ctypes.c_uint64,
        ctypes.c_void_p,
        ctypes.c_uint64,
    ]
    lib.xyg_graph_projection_copy_endpoints.restype = ctypes.c_int32
    lib.xyg_graph_projection_copy_endpoints.argtypes = [
        ctypes.c_uint64,
        ctypes.c_void_p,
        ctypes.c_void_p,
        ctypes.c_uint64,
    ]
    lib.xyg_graph_projection_copy_parents.restype = ctypes.c_int32
    lib.xyg_graph_projection_copy_parents.argtypes = [
        ctypes.c_uint64,
        ctypes.c_void_p,
        ctypes.c_void_p,
        ctypes.c_uint64,
    ]
    lib.xyg_graph_projection_destroy.restype = ctypes.c_int32
    lib.xyg_graph_projection_destroy.argtypes = [ctypes.c_uint64]
