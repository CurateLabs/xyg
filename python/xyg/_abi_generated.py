...
ABI_VERSION = 316
SIGNATURE_SHA256 = "a51d75d18b509693469bd6ef1ea50a1c633c9351b7590b9dcc3dd494d9b6acc5"
...
def bind_generated_abi(lib: ctypes.CDLL) -> None:
    ...
    # int32_t xyg_payload_density_grid_materialize(const void * meta_in, int32_t cartesian, int32_t x_linear, int32_t y_linear, int32_t categorical, int32_t compact_categorical, int32_t stratified_counts, int32_t x_has_nulls, int32_t y_has_nulls, int32_t point_overlay, int32_t grid_from_pyramid, int32_t x_memmapped, int32_t y_memmapped, int32_t has_pyramid_resource, int32_t force_bin2d, int32_t force_pyramid, int32_t color_mode, double x_min, double x_max, double y_min, double y_max, double xr0, double xr1, double yr0, double yr1, double bx0, double bx1, double by0, double by1, double x_c0, double x_c1, double y_c0, double y_c1, uint64_t n_points, size_t w, size_t h, const double * x_raw, const double * y_raw, const double * bx, const double * by, size_t len, int32_t pyramid_attempt, int32_t pyramid_resource, uint64_t pyramid_handle, int32_t pyr_colored, size_t max_upsample, size_t tile_upsample, int32_t pyramid_no_rescan, int32_t needs_pyramid_sample, int32_t pyramid_sample_stratified, const uint8_t * color_codes, const uint64_t * color_counts, size_t n_color_counts, const uint8_t * color_idx, const uint8_t * color_rgba, const uint8_t * color_lut, size_t color_lut_len, int32_t ship_mean_color, uint8_t * out_binning, size_t binning_cap, uint8_t * out_encoded, size_t encoded_cap, uint8_t * out_rgba, size_t rgba_cap, uint32_t * out_sample_sel, size_t sample_sel_cap, uint32_t * out_visible_sel, size_t visible_sel_cap, void * out)
    function = lib.xyg_payload_density_grid_materialize
    function.restype = ctypes.c_int32
    function.argtypes = [ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_uint64, ctypes.c_size_t, ctypes.c_size_t, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_int32, ctypes.c_int32, ctypes.c_uint64, ctypes.c_int32, ctypes.c_size_t, ctypes.c_size_t, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_int32, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_void_p]
