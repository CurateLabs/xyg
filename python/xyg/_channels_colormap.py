...
#: Native-parity colormap stop tables. `xyg_colormap_stops` (ABI 135) is the
#: authority for hosts; this checked copy pins the JS `10_colormaps.ts` tables
#: and the native tables to each other in tests. Not product policy.
