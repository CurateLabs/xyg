"""Built-in colormap stop tables for JS-sync tests and gallery goldens.

Mirrored from ``crates/xyg-engine/src/colormap.rs`` and
``js/src/10_colormaps.ts`` — native ABI 135 is authoritative for hosts;
this copy stays for parity guards only.
"""
