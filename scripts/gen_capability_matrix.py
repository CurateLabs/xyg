...
from xyg.styling import capabilities as caps  # noqa: E402
...
def render_public() -> str:
    ...
    lines = [
        ...
        "description: What XYG can be styled and extended with, per renderer, "
        ...
        f"- **{counts['extension_points_shipped']}** way to add a mark kind XYG does not "
