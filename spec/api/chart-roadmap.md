...
| 31 | Network/tree/org | network graph, force graph, tree, dendrogram, org chart, arc diagram | Planned later | Core feature of graphforge-xy (viz extension of GraphForge); other charts keep equal first-class feel/speed. Specs: `graph-fork-requirements.md`, `graphforge-extension.md`, `host-parity.md`. |
...
| 24 | Network / tree / org / dendrogram / arc | Graph and hierarchy compatibility. | graphforge-xy lead surface. Requirements: `spec/design/graph-fork-requirements.md`; extension split: `spec/design/graphforge-extension.md`; dual-host: `spec/design/host-parity.md`. |
