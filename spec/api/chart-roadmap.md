...
| 31 | Network/tree/org | network graph, force graph, tree, dendrogram, org chart, arc diagram | Planned later | Valuable but layout-heavy; should follow core 2D marks. Viz-only fork requirements: `spec/design/graph-fork-requirements.md`. Lead feature for platform Python↔Node parity (`spec/design/host-parity.md`). |
...
| 24 | Network / tree / org / dendrogram / arc | Graph and hierarchy compatibility. | Requires graph layout algorithms and selection semantics. Requirements: `spec/design/graph-fork-requirements.md`; dual-host: `spec/design/host-parity.md`. |
