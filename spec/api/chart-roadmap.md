...
| 31 | Network/tree/org | network graph, force graph, tree, dendrogram, org chart, arc diagram | Planned later | Core feature; other charts keep equal first-class feel/speed. Viz requirements: `spec/design/graph-fork-requirements.md`; dual-host: `spec/design/host-parity.md`. Algorithms stay in GraphForge. |
