...
| 31 | Network/tree/org | network graph, force graph, tree, dendrogram, org chart, arc diagram | Planned later | Lead feature of graphforge-xy (viz extension of core GraphForge). Viz-only requirements: `spec/design/graph-fork-requirements.md`; product split: `spec/design/graphforge-extension.md`; dual-host: `spec/design/host-parity.md`. |
