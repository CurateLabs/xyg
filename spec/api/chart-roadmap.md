...
| 31 | Network/tree/org | network graph, force graph, tree, dendrogram, org chart, arc diagram | Planned later | Valuable but layout-heavy; should follow core 2D marks. Fork requirements (competitive research vs Sigma, vis-network, D3, Ogma, NetworkX, igraph, and Plotly’s network UX) live in `spec/design/graph-fork-requirements.md`. |
...
| 24 | Network / tree / org / dendrogram / arc | Graph and hierarchy compatibility. | Requires graph layout algorithms and selection semantics. Requirements: `spec/design/graph-fork-requirements.md`. |
