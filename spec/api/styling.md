...
chart-build time by the native core's CSS grammar (`crates/xyg-engine/src/css.rs`, over
...
(`crates/xyg-engine/src/font.rs`, regenerated by `scripts/gen_font.py`) baked at a 16 px base
