...
`SCENE_VERSION` remains independently versioned and is 27 for this contract.
...
Scene v27 (`SCENE_VERSION = 27`), a 300-byte header, 64-byte trace descriptors, viewport/plot f32
