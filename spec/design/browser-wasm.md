...
`SCENE_VERSION` remains independently versioned and is 26 for this contract.
...
Scene v26 (`SCENE_VERSION = 26`), a 300-byte header, 64-byte trace descriptors, viewport/plot f32
