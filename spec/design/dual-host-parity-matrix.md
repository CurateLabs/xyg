...
| radar / polar / pie / wind_rose / facet | ready | ready | bins + bar stack; facet host-only; ABI 133 polar Scene v26 line/scatter/area/bar/column/errorbar/heatmap/contour; ABI 134 HeatmapPainted intern; ABI 135 named colormap tables; density still compatibility | Node `marks/polar.js` / `radar.js`; coords+theta/r; `tests/test_polar_scene.py` |
