...
| box / violin / ecdf / hexbin / heatmap / ribbon | ready | ready (heatmap categorical axes partial) | box/violin/hexbin/heatmap kernels; exact + ABI100 binned ECDF; ABI 102 hexbin ingress; constant-style Cartesian hexbin Scene PolyFill; constant-style Cartesian heatmap Scene Rect | Node marks + cross-host Scene goldens |
