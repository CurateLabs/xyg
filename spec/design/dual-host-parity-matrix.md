...
| radar / polar / pie / wind_rose / facet | ready | ready | bins + bar stack; facet host-only; ABI 133 polar Scene v26 line/scatter/area/bar/column/errorbar/heatmap/contour; ABI 134 HeatmapPainted intern; ABI 135 named colormap tables; ABI 136 product-kind packing; ABI 137 Cartesian density Image blit; ABI 138 constant dash XYDS; ABI 139 constant linecap XYLC; ABI 140 cartesian smooth-polyline flatten; ABI 141 cartesian smooth-area Band flatten; ABI 142 cartesian mean-color density; ABI 143 polar density PolyFill tessellation | Node `marks/polar.js` / `radar.js`; coords+theta/r; `tests/test_polar_scene.py` |
