...
| box / violin / ecdf / hexbin / heatmap / ribbon | ready | ready (heatmap categorical axes partial) | box/violin/hexbin/heatmap kernels; exact + ABI100 binned ECDF; ABI 102 hexbin ingress | Node marks + cross-host Scene goldens |
