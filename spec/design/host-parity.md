...
ABI 133 compiles polar Scene v26 line/scatter/area/bar/column/errorbar/heatmap: Python and Node pack
...
contour stays `XYG_SCENE_UNSUPPORTED_POLAR`. Polar heatmap tessellates lattice
Rects; inverse-sample `<image>` remains a compatibility exporter.
