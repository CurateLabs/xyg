...
exact Scene v16 output under a local-only strict CSP. Native Python and Node
...
record. Scene v13 now covers solid chart/plot backgrounds, authored
  ...
  rule, band, marker annotations, and bounded Rust-anchored attached labels. Extra legends, named/advanced colorbars,
  callouts/arrows and other deferred annotation forms, custom
