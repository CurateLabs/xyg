...
| `js/src/51_annotations.ts` | Shared TypeScript browser client | `browser-client` | `literal-projection-only`; Scene v16 rule/band/marker geometry, order, clipping, defaults, and bounded attached-label anchors are Rust-owned; callout/arrow and rich annotation forms remain migration debt | #116 |
