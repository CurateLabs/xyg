...
- `_marks_distribution.py` — shared box/violin multi-group helpers (Node `marks/distribution.js` parity)
...
| `python/xyg/_marks_distribution.py` | Python host | `python-host` | `keep-host`; shared box/violin multi-group helpers; mirrors Node `marks/distribution.js` | — |
