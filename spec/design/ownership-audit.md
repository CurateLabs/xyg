...
| `crates/xyg-engine/src/scene_encode_assembled.rs` | Rust safe engine | `rust-engine` | `keep-rust`; ABI 160 XYAS/XYCC assembled encode; ABI 162 XYAS/XYCF encode from sidecars; ABI 163 product encode from packed facts | — |
