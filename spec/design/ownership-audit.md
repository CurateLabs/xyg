...
lattice tessellation, ABI 192 polar painted heatmap Image blit, ABI 193 heatmap/hexbin stroke_opacity, clip, rings/spokes, and rim tick labels in `scene.rs` + `polar.rs`.
