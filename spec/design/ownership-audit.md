...
Top remaining line counts (secondary section 302): `_svg.py` ~6255, `_raster.py` ~3500, `marks.py` 3340, `_figure.py` 2488, `channels.py` 1231, `_paint.py` ~580 (shared static-export paint/geometry layer).
