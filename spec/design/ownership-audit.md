...
lattice tessellation, ABI 192 polar painted heatmap Image blit, ABI 193 heatmap/hexbin stroke_opacity, ABI 194 polar hexbin / custom reducers / categorical direct_rgba, clip, rings/spokes, and rim tick labels in `scene.rs` + `polar.rs`.
...
categorical / `direct_rgba` 1×N XYHP RGBA onto HexCell PolyFills. LOD over the 1,024-group painter
