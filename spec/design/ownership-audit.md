...
| `crates/xyg-engine/src/scene_chrome.rs` | Rust safe engine | `rust-engine` | `keep-rust`; ABI 153 XYCF figure-chrome packing | — |
| `crates/xyg-engine/src/scene_density.rs` | Rust safe engine | `rust-engine` | `keep-rust`; ABI 151 Scene density grid packing | — |
| `crates/xyg-engine/src/scene_encode_assembled.rs` | Rust safe engine | `rust-engine` | `keep-rust`; ABI 160 XYAS/XYCC assembled encode | — |
