...
| `packages/xy-node/src/factorize.js` | Node host | `node-host` | `keep-host`; native factorize/remap for fixed-width TypedArray columns; JS label-policy fallback for string arrays | — |
