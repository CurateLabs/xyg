...
- `_paint.py` — shared static-export paint/geometry layer (fill/stroke bundles, scatter/ribbon helpers, `hexbin_ring`, `polar_clip_line_segments`, CSS→RGBA8); ABI 206 `effective_rgba` marshal; `triangle_mesh_boundary` recorded stay-host joined-fill walk
