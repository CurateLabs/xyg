...
| `packages/xy-node/src/color.js` | Node host with canonical-policy debt | `node-scene-migration` | `split-and-move-rust`; ABI 213 owns CSS/numeric split, domain pad, and direct RGBA admit; ABI 251 owns clip-quantize u8; hosts still factorize labels and pin palettes | #58 |
...
| `python/xyg/channels.py` | Python host with canonical-policy debt | `python-scene-migration` | `split-and-move-rust`; ABI 213 owns CSS/numeric split, domain pad, and direct RGBA admit; ABI 251 owns clip-quantize u8; 256-texel LUT uses ABI 206; hosts still factorize labels and pin palettes | #58 |
