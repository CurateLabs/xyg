...
paints no dynamic ticks because it cannot load sibling Worker assets.
Real-browser E2E proof of this packaged
...
**Versioning & releases.** The integration ships in every `xyg` wheel and sdist,
