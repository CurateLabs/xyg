...
`XYG_SCENE_UNSUPPORTED_ANNOTATION_COLLISION` (#307). Polar stays fail-closed.
...
fail-closed as `XYG_SCENE_UNSUPPORTED_ANNOTATION_COLLISION` (#307). Hosts pack domain tick-kind in XYCF 154–155. Invalid ABI 96
