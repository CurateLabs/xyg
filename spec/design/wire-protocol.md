...
([temporal-controller.md](temporal-controller.md), ABI 80): `group_id`,
...
bytes with explicit scene-version validation; it must not translate numeric
records through JSON or silently accept unknown kinds.
