...
/// `xy_tile_store_free`, or 0 on a stale pyramid handle / I/O failure. The
...
/// No pointer arguments; safe for any handle value.
#[no_mangle]
pub unsafe extern "C" fn xy_pyramid_spill(handle: u64) -> u64 {
    ffi_guard(0, || {
...
/// matching `xy_pyramid_compose` level reporting; tiles are row-major
...
#[no_mangle]
pub unsafe extern "C" fn xy_tile_store_fetch(
    store: u64,
    level: u32,
    tx: u32,
    ty: u32,
...
/// counterpart of `xy_pyramid_compose`, bit-identical to it for the same
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub unsafe extern "C" fn xy_tile_store_compose(
    store: u64,
    lo_x: f64,
    hi_x: f64,
    lo_y: f64,
...
/// `xy_tile_store_compose` plus the mean-color plane — the tile-store
/// counterpart of `xy_pyramid_compose_color`, bit-identical to it. Returns
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub unsafe extern "C" fn xy_tile_store_compose_color(
    store: u64,
    lo_x: f64,
    hi_x: f64,
    lo_y: f64,
...
/// `x`/`y` must point to `len` readable f64s (or may be null when `len == 0`).
#[no_mangle]
pub unsafe extern "C" fn xy_tile_store_append(
    store: u64,
    x: *const f64,
    y: *const f64,
    len: usize,
...
#[no_mangle]
pub unsafe extern "C" fn xy_tile_store_stats(store: u64, out: *mut u64) -> i32 {
    if out.is_null() {
        return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xy_tile_budget_set(bytes: u64) -> i32 {
    ffi_guard(0, || {
...
/// No pointer arguments; safe for any handle value.
#[no_mangle]
pub unsafe extern "C" fn xy_tile_store_free(store: u64) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xy_graph_layout(
    layout: u32,
    n_nodes: u64,
    n_edges: u64,
    sources: *const u64,
...
#[no_mangle]
pub unsafe extern "C" fn xy_graph_force_create(
    n_nodes: u64,
    n_edges: u64,
    sources: *const u64,
    targets: *const u64,
...
#[no_mangle]
pub unsafe extern "C" fn xy_graph_force_tick(
    handle: u64,
    n_nodes: u64,
    steps: u32,
    out_x: *mut f64,
...
#[no_mangle]
pub unsafe extern "C" fn xy_graph_build_csr(
    n_nodes: u64,
    n_edges: u64,
    sources: *const u64,
    targets: *const u64,
...
#[no_mangle]
pub unsafe extern "C" fn xy_graph_cluster_aggregate(
    n_nodes: u64,
    n_edges: u64,
    x: *const f64,
    y: *const f64,
...
#[no_mangle]
pub unsafe extern "C" fn xy_sankey_layout(
    n_nodes: u64,
    n_links: u64,
    sources: *const u64,
    targets: *const u64,
...
#[no_mangle]
pub unsafe extern "C" fn xy_hexbin(
    x: *const f64,
    y: *const f64,
    c: *const f64,
    len: usize,
...
#[no_mangle]
pub unsafe extern "C" fn xy_violin_density(
    data: *const f64,
    len: usize,
    n_bins: usize,
    out_edges: *mut f64,
...
#[no_mangle]
pub unsafe extern "C" fn xy_histogram_edges(
    data: *const f64,
    len: usize,
    lo: f64,
    hi: f64,
