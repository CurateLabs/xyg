"""Baseline JPEG encoder (`xyg._jpeg`) — Pillow is the decode oracle."""
...
def test_encode_is_the_native_converter() -> None:
    from xyg import _native

    img = with_alpha(chart_rgb(32, 40))
    assert _jpeg.encode(img, quality=90) == _native.encode_jpeg(img, quality=90)
