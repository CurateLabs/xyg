...
def test_rust_scene_support_predicate_is_stable_and_fail_closed() -> None:
    ...
    assert bar_scene[4:8] == (30).to_bytes(4, "little")
    ...
    assert heat_scene[4:8] == (30).to_bytes(4, "little")
    ...
    assert contour_scene[4:8] == (30).to_bytes(4, "little")
...
def test_python_consumes_the_versioned_rust_scatter_scene() -> None:
    assert _native.scene_version() == 30
